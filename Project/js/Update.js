...
function verif_gameVersionLoading() {
    ...
    if (
        ...
        setTimeout(function () {
            ...
            if (
                fs
                    .existsSync(gamelocation + "/Games/SS/SS_Version.txt")
                    .toString() === true
            ) {
                if (portable == true) {
                    if (process.platform == "linux") {
                        if (
                            fs
                                .readFileSync(gamelocation + "/Games/SS/SS_Version.txt")
                                .toString() <
                            fs
                                .readFileSync(
                                    parentfolder3 +
                                    "/nytuolauncher_data/VersionsFiles/SS_Version.txt"
                                )
                                .toString()
                        ) {
                            SSU = false;
                        ...
                        if (
                            fs
                                ...
                                .toString() <
                            fs
                                .readFileSync(__dirname + "/VersionsFiles/SS_Version.txt")
                                .toString()
                        ) {
                            SSU = false;
                        }
...
function DLVersions() {
    if (connectedtointernet == "true") {
        ...
        if (portable == true) {
            if (process.platform == "linux" || process.platform == "darwin") {
                DownlaodVersion(
                    "https://raw.githubusercontent.com/Nytuo/SS/master/Linux/SS_Version.txt",
                    parentfolder3 + "/nytuolauncher_data/VersionsFiles/SS_Version.txt"
                );
                DownlaodVersion(
                ...
                DownlaodVersion(
                    "https://raw.githubusercontent.com/Nytuo/SS/master/Windows/SS_Version.txt",
                    __dirname + "/VersionsFiles/SS_Version.txt"
                );
                DownlaodVersion(
...
function DLCL() {
    if (connectedtointernet == "true") {
        ...
        if (portable == true) {
            if (process.platform == "linux" || process.platform == "darwin") {
                DownlaodVersion(
                    "https://raw.githubusercontent.com/Nytuo/SS/master/ChangesLogs",
                    parentfolder3 + "/nytuolauncher_data/ChangesLogs/SS.txt"
                );
                DownlaodVersion(
            ...
            if (process.platform == "linux" || process.platform == "darwin") {
                DownlaodVersion(
                    "https://raw.githubusercontent.com/Nytuo/SS/master/ChangesLogs",
                    app.getPath("documents") + "/nytuolauncher_data/ChangesLogs/SS.txt"
                );
                DownlaodVersion(
                    "https://raw.githubusercontent.com/Nytuo/SFTW/master/ChangesLogs",
