...
function LoadAchivements() {
  ...
  if (
    ...
    var AchlistSFO = require("fs")
      .readFileSync(
        __dirname + "/Achievements/SFO/AllAchievements.txt",
        "utf-8"
      )
      .split("\n");
    if (fs.existsSync(gamelocation + "/Games/SFO/Achievements/AchDone.txt")) {
      let AchListSFODone2 = require("fs")
        .readFileSync(
          gamelocation + "/Games/SFO/Achievements/AchDone.txt",
          "utf-8"
        )
      ...
      var percentage =
        ((AchListSFODone.length - 2) * 100) / (AchlistSFO.length - 1);
      if (percentage < "0") {
        percentage = 0;
      }
      console.log(percentage);
      ...
      if (
        ...
        if (percentage != "100") {
          document.getElementById("ach").innerHTML = SFOLock.toString()
            .split(",")
            .join("<br/>");
        } else {
          document.getElementById("ach").innerHTML = currentLanguage[23];
      ...
      document.getElementById("achDone").innerHTML = currentLanguage[22];
      document.getElementById("ach").innerHTML = AchlistSFO.toString()
        .split(",")
        .join("<br/>");
    }
  }
  if (
    page === "file:///" + dirnamew + "/Games.html?sgb" ||
    page === "index.html" ||
    page === "profile.php" ||
    page === "/sgb.html"
  ) {
    var AchlistSGB = require("fs")
      .readFileSync(
        __dirname + "/Achievements/SGB/AllAchievements.txt",
        "utf-8"
      )
      .split("\n");
    if (fs.existsSync(gamelocation + "/Games/SGB/Achievements/AchDone.txt")) {
      let AchListSGBDone2 = require("fs")
        .readFileSync(
          gamelocation + "/Games/SGB/Achievements/AchDone.txt",
          "utf-8"
        )
      ...
      var percentage =
        ((AchListSGBDone.length - 2) * 100) / (AchlistSGB.length - 1);
      if (percentage < "0") {
        percentage = 0;
      }
      console.log(percentage);
      ...
      if (
        ...
        if (percentage != "100") {
          document.getElementById("ach").innerHTML = SGBLock.toString()
            .split(",")
            .join("<br/>");
        } else {
          document.getElementById("ach").innerHTML = currentLanguage[23];
      ...
      document.getElementById("achDone").innerHTML = currentLanguage[22];
      document.getElementById("ach").innerHTML = AchlistSGB.toString()
        .split(",")
        .join("<br/>");
    }
  }
  if (
    page === "file:///" + dirnamew + "/Games.html?laatim" ||
    page === "index.html" ||
    page === "profile.php" ||
    page === "laatim.html"
  ) {
    var AchlistLAATIM = require("fs")
      .readFileSync(
        __dirname + "/Achievements/LAATIM/AllAchievements.txt",
        "utf-8"
      )
      .split("\n");
    if (fs.existsSync(gamelocation + "/Games/LAATIM/LA_IM/Achievements.txt")) {
      let AchListLAATIMDone2 = require("fs")
        .readFileSync(
          gamelocation + "/Games/LAATIM/LA_IM/Achievements.txt",
          "utf-8"
        )
      ...
      var percentage =
        ((AchListLAATIMDone.length - 2) * 100) / (AchlistLAATIM.length - 1);
      if (percentage < "0") {
        percentage = 0;
      }
      console.log(percentage);
      ...
      elem.style.width = percentage + "%";
      elem.innerHTML = percentage.toFixed() + "%";
      var AchListLAATIMTab = AchListLAATIMDone.slice(
        1,
        AchListLAATIMDone.length
      );
      var AchListLAATIMTXT = AchListLAATIMTab.toString()
        .split(",")
        .join("<br/>");
      if (
        page === "file:///" + dirnamew + "/Games.html?laatim" ||
        ...
        document.getElementById(
          "achDone"
        ).innerHTML = AchListLAATIMTXT.toString();
        ...
        if (percentage != "100") {
          document.getElementById(
            "ach"
          ).innerHTML = LAATIMLock.toString().split(",").join("<br/>");
        } else {
          document.getElementById("ach").innerHTML = currentLanguage[23];
        }
      }
      ...
      document.getElementById("achDone").innerHTML = currentLanguage[22];
      document.getElementById("ach").innerHTML = AchlistLAATIM.toString()
        .split(",")
        .join("<br/>");
    }
  }
  ...
  if (
    page === "file:///" + dirnamew + "/Games.html?sn" ||
    page === "profile.php" ||
    page === "index.html" ||
    page === "sn.html"
  ) {
    var AchlistSNRE = require("fs")
      .readFileSync(
        __dirname + "/Achievements/SNRE/AllAchievements.txt",
        "utf-8"
      )
      .split("\n");
    if (fs.existsSync(gamelocation + "Games/SNRE/Achievements/AchDone.txt")) {
      let AchListSNREDone2 = require("fs")
        .readFileSync(
          gamelocation + "Games/SNRE/Achievements/AchDone.txt",
          "utf-8"
        )
      ...
      var percentage =
        ((AchListSNREDone.length - 2) * 100) / (AchlistSNRE.length - 1);
      if (percentage < "0") {
        percentage = 0;
      }
      console.log(percentage);
      ...
      if (
        ...
        document.getElementById(
          "achDone"
        ).innerHTML = AchListSNRETXT.toString();
        ...
        if (percentage != "100") {
          document.getElementById("ach").innerHTML = SNRELock.toString()
            .split(",")
            .join("<br/>");
        } else {
          document.getElementById("ach").innerHTML = currentLanguage[23];
      ...
      document.getElementById("achDone").innerHTML = currentLanguage[22];
      document.getElementById("ach").innerHTML = AchlistSNRE.toString()
        .split(",")
        .join("<br/>");
    }
  }
