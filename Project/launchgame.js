...
function detectgamepage() {
    if (process.platform == "linux" || process.platform == "darwin") {
        if (window.location.href == "file://" + dirnamew + "/Gamelaunch.html?SS") {
            document.getElementById("TXTLOAD").innerHTML = currentLanguage[179];
            document.getElementById("IMGLOAD").src = "Resources/SS.png";
        ...
        if (
            window.location.href ==
            "file:///" + dirnamew + "/Gamelaunch.html?SS"
        ) {
            document.getElementById("TXTLOAD").innerHTML = currentLanguage[179];
            document.getElementById("IMGLOAD").src = "Resources/SS.png";
            document.getElementById("IMGLOAD").style.width = "35%";
...
function LAUNCH() {
    if (process.platform == "linux") {
        if (window.location.href == "file://" + dirnamew + "/Gamelaunch.html?SS") {
            setTimeout(() => {
                OpenforLinux(gamelocation, "SS", "SuperSmash.x86_64");
            }, 2000);
        }
        if (window.location.href == "file://" + dirnamew + "/Gamelaunch.html?SFTW") {
            setTimeout(() => {
